...
% disp(' ')
% disp(sprintf('Mean Error : \t\t%0.4f',error_sim)); 
...
disp(sprintf('%s=\t%0.4g\t+%s*\t%0.4g\t+%s*\t%0.4g\t+%s*\t%0.4g\t+%s*\t%0.4g\t+%s*\t%0.4g\t+%s*\t%0.4g\tVAF=\t%0.4g\n', model(7,:),x(1),model(1,:),x(2),model(2,:),x(3),model(3,:),x(4),model(4,:),x(5),model(5,:),x(6),model(6,:),x(7), VAF ));
