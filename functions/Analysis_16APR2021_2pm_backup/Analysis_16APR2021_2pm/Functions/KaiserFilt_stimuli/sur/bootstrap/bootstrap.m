...
set(h,'WindowButtonDownFcn','abort_flag = 1;','color',[.2 .5 .2],'menubar','none','name','Click Progress Bar to ABORT and SAVE...','position',[264.7500  417.0000  270.0000   56.2500]);
pause(2)
