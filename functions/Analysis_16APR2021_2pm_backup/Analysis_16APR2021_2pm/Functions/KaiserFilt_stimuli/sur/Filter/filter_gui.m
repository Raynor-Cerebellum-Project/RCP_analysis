...
%%%%%% frequency 
  ...
  %{
   ...
   F_Data(3) = uicontrol('Parent',h0, ...
      ...
      'Callback', 'filter_gui(''set_cutoff'')', ...
      'Fontsize',14, ...
      'Units','points', ...
