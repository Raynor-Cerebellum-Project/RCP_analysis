...
%% --- Setup Paths ---
base_folder = fullfile(['\\10.16.59.34\cullenlab_server\Current Project Databases - NHP' ...
...
switch session
    ...
    case 'BL_RW_003_Session_1'
        ...
        trial_indices = [6, 7, 8, 12, 13, 14, 18]; %9
    otherwise
...
for i = all_trial_indices
    ...
    try
        ...
        raw_metrics = analyze_metrics(filename, EndPoint_pos, EndPoint_neg, ...
            metadata_row, segment_fields, epextraction_plot);
