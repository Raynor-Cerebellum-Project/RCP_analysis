function [b,f,bias,LAM,BIC,Pcap]=arxbw(z,index,nn,maxsize,Tsamp);
%arxbw   Computes LS-estimates of ARX-models
%
%       [b,f,bias] = arxbw(z,ix,nn)
%
...
%
%	[b,a,bias,MSE,BIC,P] = arxbw(z,ix,nn,maxsize,Tsamp)
%

%  Modified ARX: Claudio, G. Rey - 4:45PM  12/11/93
...
%  build up the theta-matrix
   ...
   if nu>0,
      I=[LAM Tsamp nu na nb 0 0 zeros(1,nu) nk];
   else
      I=[LAM Tsamp 0 na 0 0];
   end
