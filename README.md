...
│   │   ├── aux_data              # Auxillary data other than neural data in .npz format (sync pulses etc.)
...
4. Build .npz for auxiliary data other then neural data (save as .npz file) (2 sync digital channels in .ns5 and other .ns2 files) (`br_preproc.extract_br_aux_streams_npz`) - TODO: Convert to NWB format
