...
def main():
    ...
    for k, peri_stim_npz_loc in enumerate(files):
        ...
        beh_labels_pretty = _simple_beh_labels(beh_labels_raw, KEYPOINTS_ORDER)
        ...
        # Select MWT indices
        idx_subset = _get_subset_indices(beh_labels_pretty, mode="MWT")
        ...
        def _select_dims(segs, idxs):
            ...
            return segs[:, idxs, :], [beh_labels_pretty[i] for i in idxs]
